...
function SidebarProvider({
    ...
    const toggleSidebar = React.useCallback(() => {
        return isMobile ? setOpenMobile((open: boolean): boolean => !open) : setOpen((open: boolean): boolean => !open)
    ...
    const contextValue: SidebarContextProps = React.useMemo<SidebarContextProps>(
        () => ({
            state,
            open,
            setOpen,
